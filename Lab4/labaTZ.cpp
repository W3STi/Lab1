...
void zad1(){
	...
	printf("Реализация обхода с матрицей смежности\n");
...
void zad2() {
	...
	printf("\n\nРеализация обхода со списком смежности\n");
...
void zad3() {
	...
	printf("\n\nРеализация обхода с матрицей смежности без рекурсии\n");
...
void zvezdochki() {
	...
	printf("\n\nСравнение времени обхода матрицы смежности без рекурсии\n");
